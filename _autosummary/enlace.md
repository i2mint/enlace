...
| [`analytics_report`](#enlace.analytics_report)([app, days, config, store])     | Per-app report for the last `days` days: daily series + totals.    |
|---------------------------------------------------------------------------------------------------|--------------------------------------------------------------------|
...
| [`daily_counts`](#enlace.daily_counts)(store, app, \*[, days, today, ...]) | One merged record per day for the last `days` days, oldest first.  |
...
| [`AppAnalyticsConfig`](#enlace.AppAnalyticsConfig)(\*\*data)                 | An app's `[analytics]` table in `app.toml`.                                 |
|-----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
...
| [`JsonFileStore`](#enlace.JsonFileStore)(root)                          | `key -> dict`, one JSON file per key at `{root}/{key}.json`.                |
| [`PlatformAnalyticsConfig`](#enlace.PlatformAnalyticsConfig)(\*\*data)            | The platform's `[analytics]` table in `platform.toml`.                      |
...
* **Return type:**
  [`AppImportError`](enlace.base.md#enlace.base.AppImportError)
...
* **Parameters:**
  * **conventions** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`ConventionsConfig`](enlace.base.md#enlace.base.ConventionsConfig)]) – Meta-conventions controlling discovery behavior.
...
* **Return type:**
  [`list`](https://docs.python.org/3/builtins/stdtypes.html#list)[[`AppConfig`](enlace.base.md#enlace.base.AppConfig)]
* **Returns:**
...
* **Return type:**
  [`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`AppConfig`](enlace.base.md#enlace.base.AppConfig)]
* **Returns:**
...
[`exclusive()`](#enlace.JsonFileStore.exclusive) (a cross-process lock) and [`sweep_temp_files()`](#enlace.JsonFileStore.sweep_temp_files).
...
* **Return type:**
  [`PlatformConfig`](enlace.base.md#enlace.base.PlatformConfig)
...
* **Return type:**
  [`DiagnosticReport`](enlace.diagnose.md#enlace.diagnose.DiagnosticReport)
* **Returns:**
...
* **Parameters:**
  * **config** ([`Optional`](https://docs.python.org/3/library/typing.html#typing.Optional)[[`PlatformConfig`](enlace.base.md#enlace.base.PlatformConfig)]) – Platform configuration. If None, loads from platform.toml.
...
* **Return type:**
  [`DeployManifest`](enlace.manifest.md#enlace.manifest.DeployManifest)
...
* **Parameters:**
  * **app** ([`AppConfig`](enlace.base.md#enlace.base.AppConfig)) – The app whose `[build]` section to run.
...
* **Return type:**
  [`BuildResult`](enlace.build.md#enlace.build.BuildResult)
* **Returns:**
...
| [`access`](enlace.access.md#module-enlace.access)                 | Who may reach an app: the one predicate the gate and the launcher both call.         |
|----------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| [`analytics`](enlace.analytics.md#module-enlace.analytics)           | Privacy-first page-view analytics, turned on per app.                                |
