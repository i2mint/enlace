...
| [`resolve_app_icon`](#enlace.app_icons.resolve_app_icon)(app, config, overlay, \*[, ...]) | Resolve an app's icon to an [`IconResult`](enlace.appmeta.md#enlace.appmeta.IconResult). |
...
Resolve an app’s icon to an [`IconResult`](enlace.appmeta.md#enlace.appmeta.IconResult).
